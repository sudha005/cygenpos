	...
	public function ajax_list()
	{
		...
		foreach ($list as $category) {
			...
			$row[] = '<input type="checkbox" name="checkbox[]" value='.$category->id.' class="checkbox column_checkbox" >';
				$row[] = "<a title='Click for Bigger!' href='".base_url('uploads/category/'.$category->cat_image)."' data-toggle='lightbox'>
						<image style='border:1px #72afd2 solid;' src='".base_url('uploads/category/'.$category->cat_image)."'  width='75px' height='50px' > </a>";
