...
class Items extends MY_Controller {
	...
	public function ajax_list()
	{
		...
		foreach ($list as $items) {
			...
			$row[] = "<a title='Click for Bigger!' href='".base_url($items->item_image)."' data-toggle='lightbox'>
						<image style='border:1px #72afd2 solid;' src='$imgcode'    width='75px' height='50px' > </a>";
			$row[] = $items->item_code;
			$row[] = $items->item_name;
			...
			$row[] = $str;
			 		...
			 		$str2 = '<div class="btn-group" title="View Account">
										...
										<ul role="menu" class="dropdown-menu dropdown-light pull-right">';
											...
											if($this->permissions('items_edit'))
											$str2.='<li>
												<a title="Add Item Modifier ?" href="'.base_url('itemmodifier/add/'.$items->id).'">
													<i class="fa fa-fw fa-edit text-blue"></i>Add Item Modifier
												</a>
											</li>';
												if($this->permissions('items_edit'))
											$str2.='<li>
												<a title="view" href="'.base_url('itemmodifier/view/'.$items->id).'">
													<i class="fa fa-fw fa-eye text-blue"></i>view Modifier
												</a>
											</li>';
