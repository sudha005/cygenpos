...
//	$from_email="info@Cococubanorousehill.com.au";
    	$from_email="info@chickycharchar.com.au";
	$subject = "Your Chickycharchar  new order  ( '.$order_id.' )";
	$this->email->from($from_email,"Your Chickycharchar new order  (".$order_id.")"); 
