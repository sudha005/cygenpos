...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?=$page_title;?>
        <small>View/Search Banners</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <div class="box-tools">
                <a class="btn btn-block btn-info" href="<?php echo $base_url; ?>banner/add">
                <i class="fa fa-plus"></i> <?= $this->lang->line('add_banner'); ?></a>
              </div>
              ...
              <table id="example2" class="table table-bordered table-striped" width="100%">
                ...
                <tr>
                  <th class="text-center">
                    ...
                    <th>Image</th>
                  <th><?= $this->lang->line('banner_code'); ?></th>
