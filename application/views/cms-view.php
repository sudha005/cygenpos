        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <?php if($CI->permissions('cms_add')) { ?>
              <div class="box-tools">
                <a class="btn btn-block btn-info" href="<?php echo $base_url; ?>cms/add">
                <i class="fa fa-plus"></i> <?= $this->lang->line('add_cms'); ?></a>
              </div>
              <?php } ?>
            </div>
            <!-- /.box-header -->
...
$(document).ready(function() {
 ...
 /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
      buttons: {
        ...
        "ajax": {
            "url": "<?php echo site_url('cms/ajax_list')?>",
            "type": "POST",
