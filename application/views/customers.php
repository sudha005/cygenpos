...
<div class="wrapper">
 ...
 <?php include"sidebar.php"; ?>
  ...
  <?php
    ...
    $state_code=$customer_code=$company_name=$company_mobile=$opening_balance=$offer_id='';
	}
 ?>
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <span id="tax_number_msg" style="display:none" class="text-danger"></span>
                  ...
                  <div class="form-group">
                  <label for="offer_id" class="col-sm-4 control-label">Offer
                  </label>

                  <div class="col-sm-8">
          <select class="form-control select2" id="offer_id" name="offer_id"  style="width: 100%;"  >
            <?php
            $query1="select * from db_offers where status=1";
            ...
            if($q1->num_rows($q1)>0)
             {
               ...
               {
                $selected = ($offer_id==$res1->id)? 'selected' : '';
                 echo "<option $selected value='".$res1->id."'>".$res1->offer_name."</option>";
               }
             }
             else
             {
