        ...
        <div class="col-md-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a href="<?= base_url();?>uploads/csv/examples/import-itemmodifier-example.csv"><button type="button" class="btn btn-info pull-right btnExport" title="Download Data in Excel Format"><?= $this->lang->line('download_example_format'); ?></button>
              </a>
            </div>
            <!-- /.box-header -->
        ...
        $("#import").click(function(e) {
          ...
          if(confirm("Are you sure ?")){
           ...
           // $("#import").attr('disabled',true);  //Enable Save or Update button
            $.ajax({
            type: 'POST',
            url: base_url+'import/import_item_modifiers_csv',
            data: data,
            cache: false,
            contentType: false,
            processData: false,
