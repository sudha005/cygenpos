      ...
      <div class="wrapper">
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               <h1>
                  <?=$page_title;?>
                  <small>Add/Update Item Modifiers</small>
               </h1>
               <ol class="breadcrumb">
                        ...
                        <form class="form-horizontal" id="import-form" enctype="multipart/form-data" method="POST">
                           ...
                           <div class="box-body">
                              <div class="form-group">
                                 <label for="brand" class="col-sm-2 control-label">Import Item Modifiers<label class="text-danger">*</label></label>
                                 <div class="col-sm-4">
        ...
        <div class="col-md-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a href="<?= base_url();?>uploads/csv/examples/import-itemmodifiergroup-example.csv"><button type="button" class="btn btn-info pull-right btnExport" title="Download Data in Excel Format"><?= $this->lang->line('download_example_format'); ?></button>
              </a>
            </div>
            <!-- /.box-header -->
        ...
        $("#import").click(function(e) {
          ...
          if(confirm("Are you sure ?")){
           ...
           // $("#import").attr('disabled',true);  //Enable Save or Update button
            $.ajax({
            type: 'POST',
            url: base_url+'import/import_item_modifiersgroup_csv',
            data: data,
            cache: false,
            contentType: false,
            processData: false,
