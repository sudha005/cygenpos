      ...
      <div class="wrapper">
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               <h1>
                  <?=$page_title;?>
                  <small>Add/Update Modifiers</small>
               </h1>
               <ol class="breadcrumb">
                  <li><a href="<?php echo $base_url; ?>dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                  <li><a href="<?php echo $base_url; ?>modifier/view">Modifiers List</a></li>
                        ...
                        <form class="form-horizontal" id="import-form" enctype="multipart/form-data" method="POST">
                           ...
                           <div class="box-body">
                              <div class="form-group">
                                 <label for="brand" class="col-sm-2 control-label">Import Modifiers<label class="text-danger">*</label></label>
                                 <div class="col-sm-4">
        ...
        <div class="col-md-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a href="<?= base_url();?>uploads/csv/examples/import-modifier-example.csv"><button type="button" class="btn btn-info pull-right btnExport" title="Download Data in Excel Format"><?= $this->lang->line('download_example_format'); ?></button>
              </a>
            </div>
            <!-- /.box-header -->
        ...
        $("#import").click(function(e) {
          ...
          if(confirm("Are you sure ?")){
           ...
           // $("#import").attr('disabled',true);  //Enable Save or Update button
            $.ajax({
            type: 'POST',
            url: base_url+'import/import_modifiers_csv',
            data: data,
            cache: false,
            contentType: false,
            processData: false,
            success: function(result){
              ...
              if(result=="success")
              {
                ...
                window.location=base_url+"modifier/view";
              }
