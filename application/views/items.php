                  ...
                  <div class="box box-info ">
                      ...
                      <?= form_open('#', array('class' => 'form', 'id' => 'items-form', 'enctype'=>'multipart/form-data', 'method'=>'POST'));?>
                        ...
                        <div class="box-body">
                           ...
                           <div class="row">
                              <div class="form-group col-md-4">
                                 <label for="price">Price1(Pos)<span class="text-danger">*</span></label>
                              ...
                              <div class="form-group col-md-4">
                                 <label for="price">Price2(QR) <span class="text-danger">*</span></label>
                                 <input type="text" class="form-control only_currency"  name="price2" placeholder="Price of Item without Tax"  value="<?php print $price2; ?>" >
                                 <span id="price_msg" style="display:none" class="text-danger"></span>
                              </div>
                              <div class="form-group col-md-4">
                                 <label for="price">Price3(Takeway) <span class="text-danger">*</span></label>
                                 <input type="text" class="form-control only_currency"  name="price3" placeholder="Price of Item without Tax"  value="<?php print $price3; ?>" >
                                 <span id="price_msg" style="display:none" class="text-danger"></span>
                              </div>
                              <div class="form-group col-md-4">
                                 <label for="price">Price4(Delivery) <span class="text-danger">*</span></label>
                                 <input type="text" class="form-control only_currency"  name="price4" placeholder="Price of Item without Tax"  value="<?php print $price4; ?>" >
                                 <span id="price_msg" style="display:none" class="text-danger"></span>
                              </div>
                              <div class="form-group col-md-4">
                                 <label for="price">Price5(Catering) <span class="text-danger">*</span></label>
                                 <input type="text" class="form-control only_currency"  name="price5" placeholder="Price of Item without Tax"  value="<?php print $price5; ?>" >
                                 <span id="price_msg" style="display:none" class="text-danger"></span>
                              </div>
                              <div class="form-group col-md-4">
                                 <label for="price">Price6(Uber) <span class="text-danger">*</span></label>
                                 <input type="text" class="form-control only_currency"  name="price6" placeholder="Price of Item without Tax"  value="<?php print $price6; ?>" >
                                 <span id="price_msg" style="display:none" class="text-danger"></span>
                              </div>
                              <div class="form-group col-md-4">
                                 <label for="price">Price7(MENULOG) <span class="text-danger">*</span></label>
                                 <input type="text" class="form-control only_currency"  name="price7" placeholder="Price of Item without Tax"  value="<?php print $price7; ?>" >
                                 <span id="price_msg" style="display:none" class="text-danger"></span>
                              </div>
                              <div class="form-group col-md-4">
                                 <label for="price">Price8(Doordash) <span class="text-danger">*</span></label>
                                 <input type="text" class="form-control only_currency"  name="price8" placeholder="Price of Item without Tax"  value="<?php print $price8; ?>" >
                                 <span id="price_msg" style="display:none" class="text-danger"></span>
                              </div>
                              <div class="form-group col-md-4">
                                 <label for="price">Price9(EASI) <span class="text-danger">*</span></label>
                                 <input type="text" class="form-control only_currency"  name="price9" placeholder="Price of Item without Tax"  value="<?php print $price9; ?>" >
                                 <span id="price_msg" style="display:none" class="text-danger"></span>
                              </div>
                           ...
                           <div class="row">
                              ...
                              <div class="form-group col-md-2">
                                 <label for="new_opening_stock"><?= 'Quick Product'; ?></label>
                                 <div class="custom-control custom-checkbox">
    <input type="checkbox" class="custom-control-input" id="customCheck" name="quick_food" value="1" <?php echo $quick_food==1?'checked':'' ?>>
  
  </div>
                              </div>
                              <div class="form-group col-md-2">
                                 <label for="new_opening_stock"><?= 'Modifier Product'; ?></label>
                                 <div class="custom-control custom-checkbox">
    <input type="checkbox" class="custom-control-input" id="customCheck" name="modifier" value="1" <?php echo $modifier==1?'checked':'' ?>>
                            ...
                            <div class="row">
                              <div class="form-group col-md-4">
                                 <label for="current_opening_stock">Avl start time</label>
                                 <input type="text" class="form-control"  name="avl_start_time" placeholder="time"  value="<?php print $avl_start_time; ?>" >
                                
                              </div>
                              <div class="form-group col-md-4">
                                 <label for="new_opening_stock">Avl start end</label>
                                 <input type="text" class="form-control"  name="avl_close_time" placeholder="time"  value="<?php print $avl_close_time; ?>" >
