...
<body class="hold-transition login-page" style="height:0;">
  <?php 
  //Find Logo Path
    $logo=$this->db->query("select logo from db_company")->row()->logo;
  ?>
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo $base_url; ?>login/verify_otp" method="post" id="password-form">
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="OTP" id="otp" name="otp" autofocus><span class="glyphicon glyphicon-envelope form-control-feedback"></span>
      </div>
      <div class="row">
        <!-- /.col -->
        <div class="col-md-4">
