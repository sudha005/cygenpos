...
<!-- <table align="center" width="100%" height='100%'   > -->
    ...
    <thead>
      ...
      <tr class="bg-sky"><!-- Colspan 10 -->
        ...
        <th colspan='2' class="text-center"><?= $this->lang->line('tax_rate'); ?></th>
        <th colspan='2' class="text-center"><?= $this->lang->line('qty'); ?></th>
...
<tbody>
 ...
 <?php
              ...
              foreach ($q2->result() as $res2) {
                  ...
                  echo "<td colspan='2' class='text-right'>".$res2->tax."%</td>";
                  echo "<td colspan='2' class='text-center'>".$res2->sales_qty."</td>";
                  ...
                  echo "<td colspan='2' class='text-right'>".number_format($tot_cost_before_tax,2)."</td>";
                  echo "</tr>";  
...
<tfoot>
  ...
  <tr class="bg-sky">
    <td colspan="10" class='text-center text-bold'><?= $this->lang->line('total'); ?></td>
    <td colspan="2" class='text-bold text-center'><?=number_format($tot_qty,2); ?></td>
    <td colspan="2" class='text-right' ><b><?php echo number_format(($tot_before_tax),2); ?></b></td>
