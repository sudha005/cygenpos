...
<body onload="window.print();"><!--   -->
    ...
    $created_time=substr($res3->created_time,0,-6);
	...
	<table width="98%" align="center">
		<tr>
			<td align="center">
				<span>		
				<img width='200px' src="<?php echo base_url() ?>uploads/company/<?php echo $company_logo; ?>"><br>
		            ...
		            <?php echo (!empty(trim($company_vat_number))) ? $this->lang->line('abn_number').": ".$company_vat_number."<br>" : '';?>
		        	
		            
			</span>
			</td>
		</tr>
		<tr><td align="center"><strong>-----------------Order Detail-----------------</strong></td></tr>
		<tr>
			<td>
				<table width="100%">
					<tr>
						...
						<td><b>#<?= $sales_code; ?>
						<?php
						if($sales_table!='' && $sales_table!='0'){
						    echo '- Table No '.$sales_table;
						}
						?>
						</b></td>
					</tr>
				...
				<table width="100%" cellpadding="0" cellspacing="0"  >
					...
					<tbody style="border-bottom-style: dashed;border-width: 0.1px;">
						<?php
			              ...
			              $addonaall=0;
			              $tax_amt=0;
			              $q2=$this->db->query("select a.item_id,b.item_name,a.sales_qty,a.unit_total_cost,a.price_per_unit,a.tax_amt,c.tax,a.total_cost from db_salesitems a,db_items b,db_tax c where c.id=a.tax_id and b.id=a.item_id and a.sales_id='$sales_id'");
			              foreach ($q2->result() as $res2) {
			                  echo "<tr>";  
			                  echo "<td style='padding-left: 2px; padding-right: 2px;' valign='top'>".++$i."</td>";
			                  echo "<td style='padding-left: 2px; padding-right: 2px;'>".ucwords(strtolower($res2->item_name))."</td>";
			              ...
			              $before_tax = ($subtotal+$addonaall)-$tax_amt;
			              ?>
