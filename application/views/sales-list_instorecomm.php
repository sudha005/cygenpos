...
<div class="wrapper">
  ...
  <?php 
      /*Total Invoices*/
      $total_invoice=$this->db->query("SELECT COUNT(*) as total FROM db_sales where order_type=1")->row()->total;
      /*Total Invoices Total*/
      $sal_total=$this->db->query("SELECT COALESCE(sum(grand_total),0) AS tot_sal_grand_total FROM db_sales where sales_status='Final' AND order_type=1")->row()->tot_sal_grand_total;
      /*Total Invoices Return Total*/
      $sal_return_total=$this->db->query("SELECT COALESCE(SUM(grand_total),0) AS sal_total FROM db_salesreturn where order_type=1 AND sales_id is not null")->row()->sal_total;
       //total sales due
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><?= $CI->currency($sal_return_total,$with_comma=true);?></h3>
...
$(document).ready(function() {
 ...
 /* dom:'<"row"<"col-sm-12"<"pull-left"B><"pull-right">>> <"row margin-bottom-12"<"col-sm-12"<"pull-left"l><"pull-right"fr>>>tip',*/
      buttons: {
        ...
        "ajax": {
            "url": "<?php echo site_url('sales/ajax_list_instorecomm')?>",
            "type": "POST",
