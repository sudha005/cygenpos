      ...
      <div class="navbar-custom-menu">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" title="Click To Table Top Order's">
             
              <span class="">Table Top Order's</span>
              <span  class="label label-danger  pushval3">0</span>
                  ...
                  <div class="col-xs-12 text-center " style="max-height:300px;overflow-y: scroll;">
                    <table class="table table-bordered" width="100%">
                      ...
                      <tbody>
                       <?php
                       $str ='';
                         $q2=$this->db->query("select * from db_sales  where status=1 AND order_type=3 AND  DATE(`sales_date`) = CURDATE() order by order_view desc limit 0,5");
          if($q2->num_rows()>0){
            foreach($q2->result() as $res2){
                 $url=base_url()."Storepickuppos?slid=".$res2->id;
                  $str =$str."<tr>";
                  ...
                  $str =$str."<td>".$res2->grand_total."</td>";
                   ...
                   $str =$str."<td>";
                 $str =$str.'<a class="fa fa-fw fa-print text-success" style="cursor: pointer;font-size: 20px;" onclick="print_invoice('.$res2->id.')" title="Print Order?"></a>';
                  $str =$str."</td>";
                $str =$str."</tr>";
...
<li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" title="Click To View Take away">
             
               <span class="">Take away</span>
               <span  class="label label-danger  pushval4">0</span>
                  ...
                  <div class="col-xs-12 text-center " style="max-height:300px;overflow-y: scroll;">
                    <table class="table table-bordered" width="100%">
                      ...
                      <tbody>
                       <?php
                       $str ='';
                         $q2=$this->db->query("select * from db_sales  where status=1 AND order_type=1 AND  DATE(`sales_date`) = CURDATE()  order by order_view desc limit 0,5");
          if($q2->num_rows()>0){
            foreach($q2->result() as $res2){
                 $url=base_url()."Storepickuppos?slid=".$res2->id;
                  $str =$str."<tr>";
          ...
          echo $str;
              ...
              <!--</li>-->
               ...
               <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" title="Last Order's">
             
           <span class="">Last Order's</span>
            </a>
                  ...
                  <div class="col-xs-12 text-center " style="max-height:300px;overflow-y: scroll;">
                    <table class="table table-bordered" width="100%">
                      ...
                      <tbody>
                       <?php
                       $str ='';
                         $q2=$this->db->query("select * from db_sales  where status=1 AND  DATE(`sales_date`) = CURDATE()  order by id desc limit 0,5");
          if($q2->num_rows()>0){
            foreach($q2->result() as $res2){
          ...
          <!-- User Account Menu -->
            ...
            <!--<a href="<?php echo base_url() ?>sales/instorecomm_sale"  title="Click To View Table Top">-->
            ...
            <!--</li>-->
            <!-- <li class="dropdown tasks-menu">-->
            <!--<a href="<?php echo base_url() ?>sales/storepickup_sale"  title="Click To View Table Top">-->
             
            <!--  <span class="">Store Pickup</span>-->
            <!--  <span  class="label label-danger  pushval4">0</span>-->
            <!--</a>-->
            <!--</li>-->
            <!--  <li class="dropdown tasks-menu">-->
            <!--<a href="<?php echo base_url() ?>sales/storepickup_sale"  title="Click To Confirm Orders">-->
             
            <!--  <span class="">Confirm Orders</span>-->
            <!--  <span  class="label label-danger  pushval5">0</span>-->
            <!--</a>-->
            <!--</li>-->
            <li class="dropdown tasks-menu">
  ...
  <aside class="main-sidebar">
    ...
    <?php if($CI->permissions('sales_add')  || $CI->permissions('sales_view') || $CI->permissions('sales_return_view')) { ?>
        ...
        <li class="sales-list-active-li"><a href="<?php echo $base_url; ?>sales"><i class="fa fa-list "></i> <span><?= $this->lang->line('sales_list'); ?></span></a></li>
         <li class="sales-list-active-li"><a href="<?php echo $base_url; ?>sales/online_sale"><i class="fa fa-list "></i> <span>Online Sales</span></a></li>
        <li class="sales-list-active-li"><a href="<?php echo $base_url; ?>sales/storepickup_sale"><i class="fa fa-list "></i> <span>Store Pickup Sales</span></a></li>
        <li class="sales-list-active-li"><a href="<?php echo $base_url; ?>sales/instorecomm_sale"><i class="fa fa-list "></i> <span>Table Top Sales</span></a></li>
        <?php } ?>
    ...
    <li class="customers-view-active-li customers-active-li import_customers-active-li treeview">
        ...
        <?php if($CI->permissions('customers_view')) { ?>
         ...
         <?php } ?>
         <li class="customersspecificprice-view-active-li"><a href="<?php echo $base_url; ?>customerspecificprice/view"><i class="fa fa-list "></i> <span>Customer Specific Price</span></a></li>
    ...
    <?php if($CI->permissions('purchase_add') || $CI->permissions('purchase_view') || $CI->permissions('purchase_return_view')) { ?>
        ...
        <li class="items-list-active-li items-active-li  category-view-active-li category-active-li brand-active-li brand-view-active-li labels-active-li import_items-active-li treeview">
          ...
          <ul class="treeview-menu">
            ...
            <?php } ?>
             <li class="modifiergroup-active-li"><a href="<?php echo $base_url; ?>modifiergroup/add"><i class="fa fa-plus-square-o "></i> <span>New Modifier Group</span></a></li>
           
            
            <li class="modifiergroup-list-active-li"><a href="<?php echo $base_url; ?>modifiergroup/view"><i class="fa fa-list "></i> <span>Modifier Group List</span></a></li>
             <li class="modifier-active-li"><a href="<?php echo $base_url; ?>modifier/add"><i class="fa fa-plus-square-o "></i> <span>New Modifier</span></a></li>
           
            
            <li class="modifier-list-active-li"><a href="<?php echo $base_url; ?>modifier/view"><i class="fa fa-list "></i> <span>Modifier List</span></a></li>
            <li class="import_modifiers-active-li"><a href="<?php echo $base_url; ?>import/modifiers"><i class="fa fa-arrow-circle-o-left "></i> <span>Import Modifiers</span></a></li>
            <li class="import_item_modifiers-active-li"><a href="<?php echo $base_url; ?>import/itemmodifiers"><i class="fa fa-arrow-circle-o-left "></i> <span>Import Item Modifiers</span></a></li>
            ...
            <?php } ?>
              <li class="banner-active-li"><a href="<?php echo $base_url; ?>banner/add"><i class="fa fa-plus-square-o "></i> <span>New Banner</span></a></li>
           
            <li class="banner-view-active-li"><a href="<?php echo $base_url; ?>banner/view"><i class="fa fa-list "></i> <span>Banner List</span></a></li>
            ...
            <?php if($CI->permissions('import_items')) { ?>
               ...
               <?php } ?>
            <li class="offer-active-li"><a href="<?php echo $base_url; ?>offer/add"><i class="fa fa-plus-square-o "></i> <span>New Offer</span></a></li>
           
            <li class="offer-view-active-li"><a href="<?php echo $base_url; ?>offer/view"><i class="fa fa-list "></i> <span>Offer List</span></a></li>
           <li class="tax-active-li  tax-list-active-li"><a href="<?php echo $base_url; ?>RestaurantTables/view"><i class="fa fa-list"></i> <span> Restaurant Tables</span></a></li>
    ...
    <?php } ?>
     ...
     <li class="items-list-active-li items-active-li  category-view-active-li category-active-li brand-active-li brand-view-active-li labels-active-li import_items-active-li treeview">
          <a href="#">
            <i class="fa fa-cubes text-aqua"></i> <span>Coupon</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="items-active-li"><a href="<?php echo $base_url; ?>coupon/add"><i class="fa fa-plus-square-o "></i> <span>Coupon</span></a></li>
            <li class="items-list-active-li"><a href="<?php echo $base_url; ?>coupon"><i class="fa fa-list "></i> <span>Coupon List</span></a></li>
          </ul>
        </li>
