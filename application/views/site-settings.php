                                          ...
                                          <div class="row">
                                             <div class="col-md-5">
                                               ...
                                               ?>
                                                ...
                                                <?php 
                                               $catbgimg_pos_checkbox ='';
                                               if($catbgimg_pos==1){
                                                $catbgimg_pos_checkbox='checked';
                                               }
                                               ?>
                                                <div class="form-group">
                                                   <label for="round_off" class="col-sm-4 control-label">Show Category Image in POS<label class="text-danger">*</label></label>
                                                   <div class="col-sm-4">
                                                      <input type="checkbox" <?=$catbgimg_pos_checkbox;?> class="form-control" id="catbgimg_pos" name="catbgimg_pos" >
                                                      <span id="catbgimg_pos_msg" style="display:none" class="text-danger"></span>
                                                   </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                   <label for="round_off" class="col-sm-4 control-label">Uber eats (%)<label class="text-danger">*</label></label>
                                                   <div class="col-sm-4">
                                                      <input type="text" class="form-control"  name="uber" placeholder=""  value="<?php print $uber; ?>" >
                                                   </div>
                                                </div>
                                                <div class="form-group">
                                                   <label for="round_off" class="col-sm-4 control-label">Menulog (%)<label class="text-danger">*</label></label>
                                                   <div class="col-sm-4">
                                                     <input type="text" class="form-control"  name="menulog" placeholder=""  value="<?php print $menulog; ?>" >
                                                   </div>
                                                </div>
                                                <div class="form-group">
                                                   <label for="round_off" class="col-sm-4 control-label">DoorDash (%)<label class="text-danger">*</label></label>
                                                   <div class="col-sm-4">
                                                    <input type="text" class="form-control"  name="door_dash" placeholder=""  value="<?php print $door_dash; ?>" >
                                                   </div>
                                                </div>
                                            ...
                                            <div class="col-md-5 ">
                                             <div class="form-group">
                                                   <label for="round_off" class="col-sm-4 control-label">Opening Time<label class="text-danger">*</label></label>
                                                   <div class="col-sm-4">
                                                    <input type="text" class="form-control"  name="open_time" placeholder=""  value="<?php print $open_time; ?>" >
                                                   </div>
                                                </div>
                                            </div>
                                            <div class="col-md-5 ">
                                             <div class="form-group">
                                                   <label for="round_off" class="col-sm-4 control-label">Close Time<label class="text-danger">*</label></label>
                                                   <div class="col-sm-4">
                                                    <input type="text" class="form-control"  name="close_time" placeholder=""  value="<?php print $close_time; ?>" >
                                                   </div>
                                                </div>
                                            </div>
                                             <!-- ########### -->
