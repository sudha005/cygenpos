    ...
    if(this_id=="save")  //Save start
    {
					...
					if(confirm("Do You Wants to Save Record ?")){
						...
						//alert(result);
							if(result=="success")
							{
								...
								window.location=base_url+"coupon";
								return;
							}
				...
				//e.preventDefault
					...
					if(confirm("Do You Wants to Update Record ?")){
						...
						$.ajax({
						type: 'POST',
						url: base_url+'coupon/update_coupon',
						data: data,
						cache: false,
						contentType: false,
						processData: false,
...
{
	$.post("coupon/update_status",{id:id,status:status},function(result){
		if(result=="success")
				{
...
function delete_country(q_id)
{
   if(confirm("Do You Wants to Delete Record ?")){
   	$(".box").append('<div class="overlay"><i class="fa fa-refresh fa-spin"></i></div>');
   $.post("coupon/delete_country",{q_id:q_id},function(result){
   //alert(result);return;
	   if(result=="success")
				{
