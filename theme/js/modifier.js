...
$('#save,#update').click(function (e) {
	...
	check_field("modifier_name");
	check_field("modifier_price");
    ...
    if(this_id=="save")  //Save start
    {
					if(confirm("Do You Wants to Save Record ?")){
						e.preventDefault();
						data = new FormData($('#modifier-form')[0]);//form name
						/*Check XSS Code*/
						...
						$.ajax({
						type: 'POST',
						url: base_url+'modifier/newmodifier',
						data: data,
						cache: false,
						contentType: false,
						processData: false,
	...
	else if(this_id=="update")  //Save start
    {
					...
					if(confirm("Do You Wants to Update Record ?")){
						...
						$.ajax({
						type: 'POST',
						url: base_url+'modifier/update_modifier',
						data: data,
						cache: false,
						contentType: false,
						processData: false,
